...
<ul>
	<li class="user"><div class="dropdown">
			  ...
			  <ul class="dropdown-menu logout" aria-labelledby="dropdownMenu1">
			    ...
			    <li><a href="admin?page=editProfile">Edit profile</a></li>
	...
	<li><a href="admin?page=images"><i class="fa fa-image"></i> Gallery</a></li>
 	<li role="separator" class="divider"></li>
	...
	<li role="separator" class="divider"></li>
	<li><a href="admin?page=bookings"><i class="fa fa-calendar-check-o"></i> Bookings</a></li>
	...
	<li><a href="admin?page=translator"><i class="fa fa-language"></i> Translator</a></li>
